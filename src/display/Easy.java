	...
	public Easy() {
		...
		JButton end = new JButton(b_end);
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (num == 0) {
					num = JOptionPane.showConfirmDialog(null, "정말로 정말로 종료 하시나요???", "종료2", JOptionPane.YES_NO_OPTION);
					if (num == 0) {
						JOptionPane.showMessageDialog(null,"안녕히 가세요" , "안녕히 가세요", JOptionPane.INFORMATION_MESSAGE);
						System.exit(0);
					}
				}
				JOptionPane.showMessageDialog(null,"잘 생각해셨습니다!" , "", JOptionPane.INFORMATION_MESSAGE);
			}
		});
